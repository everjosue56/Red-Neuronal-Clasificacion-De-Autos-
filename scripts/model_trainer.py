...
model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(3, activation='softmax')  # Cambia según número de clases
])
...
model.save('models/cars_classificator.h5')
...
plt.savefig('results/training_graphs.png')
plt.show()
...
print("-------- Modelo guardado como cars_classificator.h5  ---------")
